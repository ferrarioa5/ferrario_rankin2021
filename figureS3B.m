...
TI=0.2; TH=0.5; DE=0.03; TD=0.025; PR=17; TR=1/PR; a=0.6; b=2;
% LIM=[1.4,2.3];
% YLIM=[0.21,0.7];
LIM=[0.5,3];
YLIM=[0,1];
...
%% CONNECT states 
states.ZcS=@(a,b,c,d,TR) (C4_m(a,b,c,d,TR)<0).*(C4_p(a,b,c,d,TR)>=0).*(C2_p(a,b,c,d,TR)>=0).*(C9(a,b,c,d,TR)<0);
states.ZcAP=@(a,b,c,d,TR) (C2_p(a,b,c,d,TR)<0).*(C3_p(a,b,c,d,TR)>=0).*(C3_m(a,b,c,d,TR)<0); 
states.ZcAS=@(a,b,c,d,TR) (C5_p(a,b,c,d,TR)<0).*(C3_p(a,b,c,d,TR)>=0).*(C3_m(a,b,c,d,TR)<0).*(C2_p(a,b,c,d,TR)>=0).*(c-TH>exp(TR/TI).*(d-TH)).*(C10(a,b,c,d,TR)<0) + ...
                    (C5_p(a,b,c,d,TR)<0).*(C8_p(a,b,c,d,TR)>=0).*(C8_m(a,b,c,d,TR)<0).*(c-TH<=exp(TR/TI).*(d-TH)).*(C3_p(a,b,c,d,TR)>=0).*(C10(a,b,c,d,TR)<0) ; 
states.ZcI=@(a,b,c,d,TR) (C3_p(a,b,c,d,TR)>=0).*(C3_m(a,b,c,d,TR)<0).*(C5_p(a,b,c,d,TR)>=0).*(C10(a,b,c,d,TR)<0) ; 
states.ScAS=@(a,b,c,d,TR) (C5_p(a,b,c,d,TR)<0).*(C8_m(a,b,c,d,TR)>=0).*(C6_m(a,b,c,d,TR)<0).*(C3_p(a,b,c,d,TR)>=0).*(C10(a,b,c,d,TR)<0) ; 
states.SDcAS=@(a,b,c,d,TR) (C8_m(a,b,c,d,TR)>=0).*(C5_p(a,b,c,d,TR)<0).*(C6_m(a,b,c,d,TR)>=0).*(C3_p(a,b,c,d,TR)>=0).*(C3_m(a,b,c,d,TR)<0).*(C10(a,b,c,d,TR)<0) ; 
states.ScSD=@(a,b,c,d,TR) (C4_m(a,b,c,d,TR)>=0).*(C3_p(a,b,c,d,TR)<0).*(C2_p(a,b,c,d,TR)>=0).*(C2_m(a,b,c,d,TR)<0).*(C9(a,b,c,d,TR)<0) ; 
states.APcAS=@(a,b,c,d,TR) (C3_m(a,b,c,d,TR)>=0).*(C5_p(a,b,c,d,TR)<0).*(C2_p(a,b,c,d,TR)>=0).*(C2_m(a,b,c,d,TR)<0).*(C10(a,b,c,d,TR)<0) ; 
states.APcI=@(a,b,c,d,TR) (C3_m(a,b,c,d,TR)>=0).*(C5_p(a,b,c,d,TR)>=0).*(C5_m(a,b,c,d,TR)<0).*(C10(a,b,c,d,TR)<0) ;
...
plot3(2.9, 0.44,count+1,'o','MarkerFaceColor','w','MarkerEdgeColor','k','MarkerSize',7)
